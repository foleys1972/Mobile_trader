...
REM This script sets up the testing environment for Windows users (backend only)

echo 🚀 Setting up Direct Trader Communications Testing Environment (Windows)
echo =========================================================================
...
echo 📱 iOS Testing Environment...
echo ⚠️  iOS testing requires macOS with Xcode. Skipping iOS setup for Windows.
echo.
...
echo     },>> test_data\sample_bank_config.json
echo     {>> test_data\sample_bank_config.json
echo       "id": "mrd-1",>> test_data\sample_bank_config.json
echo       "name": "Client A",>> test_data\sample_bank_config.json
echo       "number": "3001",>> test_data\sample_bank_config.json
echo       "type": "mrd",>> test_data\sample_bank_config.json
echo       "status": "ready",>> test_data\sample_bank_config.json
echo       "participants": []>> test_data\sample_bank_config.json
echo     }>> test_data\sample_bank_config.json
echo   ]>> test_data\sample_bank_config.json
...
echo    Documentation\Windows_Testing_Guide.md
echo.
echo 🔧 Quick Commands:
